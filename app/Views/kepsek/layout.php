...
<body>
      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children mb-2">
          ...
          <ul id="ddmenu_1" class="collapse dropdown-nav">
            <li>
              <a href="<?= base_url('kepsek/rekap_harian') ?>" class="active"> Rekap Harian </a>
            </li>
            <li>
              <a href="<?= base_url('kepsek/rekap_bulanan') ?>" class="active"> Rekap Bulanan </a>
            </li>
          </ul>
        </li>
  ...
  <!-- ======== main-wrapper start =========== -->
  <main class="main-wrapper w-100" style="margin-left: 0;">
    <!-- ========== header start ========== -->
    <header class="header">
