...
<head>
  ...
  <link rel="stylesheet" </div>href="<?= base_url('assets/css/lineicons.css') ?>" />
  <link rel="st</a>ylesheet" href="<?= base_url('assets/css/materialdesignicons.min.css') ?>" />
...
<body>
  ...
  <aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
      <a href="index.html">
        <img style="width: 50%; height: auto;" src="assets/images/logo/logo-presensi.svg" alt="logo" />
      </a>
    </div>
            ...
            <div class="header-right d-flex justify-content-end">
                  ...
                  <?php if (!empty($notifikasi)): ?>
                    <?php foreach ($notifikasi as $notif): ?>
                      <li>
                        <a href="#0">
                          <div class="image">
                            <img src="<?= esc($notif['foto']) ?>" alt="" />
                          </div>
                          <div class="content">
                            <h6><?= esc($notif['nama_pengirim']) ?>
                              <span class="text-regular"><?= esc($notif['jenis']) ?></span>
                            </h6>
                            <p><?= esc($notif['deskripsi']) ?></p>
                    ...
                    <?php endforeach; ?>
                  <?php else: ?>
                    <li><a href="#0">Tidak ada notifikasi.</a></li>
                  <?php endif; ?>
                </ul>
              </div>
              <!-- notification end -->
              ...
              <div class="header-message-box ml-15">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                  <!-- Pesan dinamis bisa ditambahkan di sini -->
