...
<body>
      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children mb-2">
          <a
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
              ...
              stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-database">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <ul id="master-data" class="collapse dropdown-nav">
            <li>
              <a href="<?= base_url('admin/data_pegawai') ?>" class="active"> Data Guru </a>
            </li>
            <li>
              <a href="<?= base_url('admin/jabatan') ?>" class="active"> Data Jabatan </a>
            </li>
            <li>
              <a href="<?= base_url('admin/lokasi_presensi') ?>" class="active"> Lokasi Absensi </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item nav-item-has-children mb-2">
          ...
          <ul id="ddmenu_1" class="collapse dropdown-nav">
            <li>
              <a href="<?= base_url('admin/rekap_harian') ?>" class="active"> Rekap Harian </a>
            </li>
            <li>
              <a href="<?= base_url('admin/rekap_bulanan') ?>" class="active"> Rekap Bulanan </a>
            </li>
          </ul>
        </li>
  ...
  <<main class="main-wrapper">
            ...
            <div class="header-right d-flex justify-content-end">
              ...
              <div class="notification-box">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                  <?php if (!empty($notifikasi)) : ?>
                    <?php foreach ($notifikasi as $index => $notif) : ?>
                      <li>
                        <a href="#0">
                          <div class="content">
                            <h6><?= ($index + 1) . '. ' . (isset($notif['judul']) ? esc($notif['judul']) : 'Pemberitahuan') ?></h6>
                    ...
                    <li>
                      <form action="<?= base_url('admin/notifikasi/clear') ?>" method="post" class="text-center px-2">
                        <button type="submit" class="btn btn-sm btn-danger w-100">Clear Notification</button>
                      </form>
                    </li>
                  <?php else : ?>
                    <li class="text-center p-2">Tidak ada notifikasi</li>
                  <?php endif; ?>
                </ul>
              </div>
              <!-- notification end -->
              ...
              <div class="header-message-box ml-15">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                  <li><a href="#0">Tidak ada pesan baru.</a></li>
                </ul>
              </div>
              <!-- message end -->
    ...
    <script>
      ...
      // sweetalert berhasil
      $(function() {
        let message = "<?= session()->getFlashdata('success') ?>";
        if (message) {
