...
<div class="container my-4 px-2 px-md-4">
    <form class="row g-2 align-items-center mb-3" method="get" action="<?= base_url('admin/rekap_bulanan') ?>">
        <div class="col-auto">
    ...
    <div class="mb-3 d-flex flex-wrap gap-2">
        <a href="<?= base_url('admin/rekap/export-excel?tanggal=' . $tanggal) ?>" class="btn btn-success btn-sm">
            📥 Export Excel
        </a>
        <a href="<?= base_url('admin/rekappresensi/export_pdf_all?filter_bulan=' . $bulan . '&filter_tahun=' . $tahun) ?>"
